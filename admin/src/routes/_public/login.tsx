        ...
        <div className="w-full max-w-[420px]">
          <div className="admin-card !p-10 shadow-xl border-slate-200/60">
            ...
            <div className="mb-10 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-main-text text-white rounded-2xl mb-4 shadow-lg">
                <LockKeyhole size={24} />
              </div>
              <h1 className="text-2xl font-bold tracking-tight">Admin Portal</h1>
              <p className="text-muted-text text-sm mt-2">Vui lòng đăng nhập để tiếp tục quản trị hệ thống.</p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <Field className="space-y-2">
                ...
                <div className="relative group">
                  <LockKeyhole className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors" size={18} />
                  <Input
                      type="password"
                      placeholder="••••••••"
                      required
