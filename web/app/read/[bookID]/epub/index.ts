...
import {Font, Theme, ThemeCodes} from "@/app/read/[bookID]/types/type";
...
export class EpubEngine {
    ...
    async render(elementRef: HTMLElement) {
        ...
        //
        // this.book.locations.generate(150).then(res => {
        //     console.log(res);
        //     const progress = this.book.locations.percentageFromCfi('epubcfi(/6/20!/4/2/618/2/1:0)');
        //     const percent = Math.floor(progress * 100)
        //     console.log(`Tien do ${percent}%`)
        //
        // })
